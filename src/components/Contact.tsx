...
const Contact = () => {
  ...
  const onSubmit = async (data: FormValues) => {
    ...
    try {
      await emailjs.send(
        'service_4lqbbpk', // Service ID
        'template_1noc9bw', // Template ID
        {
          from_name: data.name,
            ...
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                    ...
                    <FormItem>
                      ...
                      <FormControl>
                        <Input 
                          ...
                          className="bg-white/5 border border-white/10 text-white focus:ring-portfolio-purple/50"
                          {...field} 
                        />
                      </FormControl>
                ...
                <Button 
                  ...
                  className="w-full bg-portfolio-purple hover:bg-purple-600 text-white py-2 px-4 rounded-lg transition-all duration-300 h-auto"
                >
                  {isSubmitting ? (
